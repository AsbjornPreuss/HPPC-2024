...
class local_spins{
    ...
    void padded_index_to_global_index(int p_index, int &g_index,int global_x, int global_y, int global_z){
        int local_index = padded_index_to_index(p_index);
        int x,y,z;
        index_to_coordinates(local_index,x,y,z);
        x += offset_x+1;
        y += offset_y+1;
        z += offset_z+1;
