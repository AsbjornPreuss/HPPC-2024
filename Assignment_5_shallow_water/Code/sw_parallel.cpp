...
void integrate(Water &w, const real_t dt, const real_t dx, const real_t dy, const real_t g) {
    ...
    #pragma acc parallel loop gang vector collapse(2) present(w)
    ...
    #pragma acc parallel loop gang vector collapse(2)  //present(w.e[0:NX][0:NY],w.u[0:NX][0:NY],w.v[0:NX][0:NY], dt, dx, dy, g)
